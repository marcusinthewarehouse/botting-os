...
export type { DiscordWebhookPayload, DiscordEmbed, EmbedField, CheckoutEvent } from './types';

const BOT_PARSERS: Record<string, (embed: NonNullable<DiscordWebhookPayload['embeds']>[0]) => Partial<CheckoutEvent>> = {
