...
export function EntryCard({ entry, onEdit, onDelete }: EntryCardProps) {
  ...
  return (
    <Card className="p-4 bg-card border-border transition-colors duration-150 hover:border-primary/30 group">
      <div className="flex items-start justify-between mb-3">
        <div>
          <h3 className="text-sm font-medium text-foreground">{entry.site}</h3>
        </div>
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <button
          ...
          className="p-1.5 rounded text-muted-foreground hover:text-foreground hover:bg-muted transition-colors duration-150 shrink-0"
        >
