  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <KpiCard
        ...
        trendDirection={
          d.profitTrend > 0 ? "up" : d.profitTrend < 0 ? "down" : "neutral"
        }
        className={
          d.totalProfit >= 0
      ...
      />
      <KpiCard title="Total Spend" value={fmtCurrency(d.totalSpend)} />
      <KpiCard title="Items Sold" value={String(d.itemsSold)} />
      <KpiCard
        title="Avg ROI"
