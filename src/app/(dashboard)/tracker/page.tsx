        ...
        <>
          ...
          <div className="flex flex-wrap items-center gap-2 mt-6 mb-4">
            ...
            <select
              ...
              className="h-9 rounded-md border border-border bg-card px-3 text-sm text-muted-foreground"
            >
              {TYPES.map((t) => (
                  ...
                  {filtered.map((entry) => {
                    ...
                    return (
                      <TableRow key={entry.id}>
                        ...
                        <TableCell className="text-sm text-foreground/80 max-w-64 truncate">
                          {entry.description}
                        </TableCell>
                        <TableCell>
                          <span
